...
import com.tty.myday.view.adapter.ScheduleTagAdapter
import com.tty.myday.view.converter.ColorIconConverter
import com.tty.myday.view.helper.SwiftTouchHelperCallBack
...
//    }
    ...
    inner class SharedMoveItemListener:SwiftTouchHelperCallBack.OnItemTouchCallBackListener<ScheduleTagAdapter.ViewHolder>{
        ...
        override fun onMove(srcPosition: Int, targetPosition: Int): Boolean {
            ...
            if (srcPosition in 0 until size && targetPosition in 0 until size){
